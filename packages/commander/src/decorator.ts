import { APP_INIT, ClassMetadata, createClassDecorator, createMethodDecorator, createPropertyDecorator, DependencyContainer, InjectionToken, Injector, MethodMetadata, PropertyMetadata, registry } from "@decopro/core";
