...
```
 @decopro/dpml@1.0.3 test /home/sker/桌面/autopro/packages/dpml
> tsx src/main.ts
  ...
  "children": [
    {
      ...
      "personality": {
        "attributes": [],
        "content": "你是一个严谨的软件架构师，擅长设计高可用系统"
      }
    },
    {
      "attributes": [],
      "contents": [
        {
          "attributes": [],
          "content": "1.分析需求<br/>2.设计架构图<br/>3.编写文档"
        },
        "@aws-s3:design-specs?version=latest"
      ]
    }
