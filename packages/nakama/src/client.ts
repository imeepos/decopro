...
export class Client {
    ...
    async addGroupUsers(
        ...
        return this.apiClient
            .addGroupUsers(session.token, groupId, ids)
            .then((response: any) => {
    ...
    authenticateEmail(
        ...
        return this.apiClient
            .authenticateEmail(this.serverkey, "", request, create, username)
            .then((apiSession: ApiSession) => {
                return new Session(
                    apiSession.token || "",
                    apiSession.refresh_token || "",
    ...
    async banGroupUsers(
        ...
        return this.apiClient
            .banGroupUsers(session.token, groupId, ids)
            .then((response: any) => {
                return response !== undefined;
            });
    }
    ...
    async createGroup(
        ...
        return this.apiClient
            .createGroup(session.token, request)
            .then((response: ApiGroup) => {
    ...
    async deleteGroup(session: Session, groupId: string): Promise<boolean> {
        ...
        return this.apiClient
            .deleteGroup(session.token, groupId)
            .then((response: any) => {
                return response !== undefined;
            });
    }
    ...
    async deleteStorageObjects(
        ...
        return this.apiClient
            .deleteStorageObjects(session.token, request)
            .then((response: any) => {
                return Promise.resolve(response != undefined);
            });
    }
    ...
    async deleteTournamentRecord(
        session: Session,
        tournamentId: string
    ): Promise<any> {
        return this.apiClient.deleteTournamentRecord(
            session.token,
            tournamentId
        );
    }
    ...
    async demoteGroupUsers(
        ...
        return this.apiClient
            .demoteGroupUsers(session.token, groupId, ids)
            .then((response: any) => {
                return Promise.resolve(response != undefined);
            });
    }
    ...
    async getSubscription(
        session: Session,
        productId: string
    ): Promise<ApiValidatedSubscription> {
        if (
            this.autoRefreshSession &&
            session.refresh_token &&
            session.isexpired((Date.now() + this.expiredTimespanMs) / 1000)
    ...
    async joinGroup(session: Session, groupId: string): Promise<boolean> {
        ...
        return this.apiClient
            .joinGroup(session.token, groupId, {})
            .then((response: any) => {
                return response !== undefined;
            });
    }
    ...
    async joinTournament(
        ...
        return this.apiClient
            .joinTournament(session.token, tournamentId, {})
            .then((response: any) => {
                return response !== undefined;
            });
    }
    ...
    async kickGroupUsers(
        ...
        return this.apiClient
            .kickGroupUsers(session.token, groupId, ids)
            .then((response: any) => {
                return Promise.resolve(response != undefined);
            });
    }
    ...
    async listGroupUsers(
        ...
        return this.apiClient
            .listGroupUsers(session.token, groupId, limit, state, cursor)
            .then((response: ApiGroupUserList) => {
    ...
    async listUserGroups(
        ...
        return this.apiClient
            .listUserGroups(session.token, userId, state, limit, cursor)
            .then((response: ApiUserGroupList) => {
                    ...
                    result.user_groups!.push({
                        group: {
                            ...
                            edge_count: ug.group!.edge_count
                                ? Number(ug.group!.edge_count)
                                : 0,
                            id: ug.group!.id,
                            lang_tag: ug.group!.lang_tag,
                            max_count: ug.group!.max_count,
                            metadata: ug.group!.metadata
                                ? JSON.parse(ug.group!.metadata!)
                                : undefined,
                            name: ug.group!.name,
                            open: ug.group!.open,
    ...
    async listGroups(
        ...
        return this.apiClient
            .listGroups(session.token, name, cursor, limit)
            .then((response: ApiGroupList) => {
                    ...
                    result.friends!.push({
                        user: {
                            ...
                            facebook_instant_game_id:
                                f.user!.facebook_instant_game_id!
                        },
                        state: f.state
                    });
                });
    ...
    async listFriendsOfFriends(
        session: Session,
        limit?: number,
        cursor?: string
    ): Promise<FriendsOfFriends> {
        if (
            this.autoRefreshSession &&
            session.refresh_token &&
            session.isexpired((Date.now() + this.expiredTimespanMs) / 1000)
        ...
        return this.apiClient
            .listFriendsOfFriends(session.token, limit, cursor)
            .then((response: ApiFriendsOfFriendsList) => {
        ...
        return this.apiClient
            ...
            .then((response: ApiLeaderboardRecordList) => {
                var list: LeaderboardRecordList = {
                    next_cursor: response.next_cursor,
                    prev_cursor: response.prev_cursor,
                    rank_count: response.rank_count
                        ? Number(response.rank_count)
                        : 0,
                    owner_records: [],
                    records: []
                };
                ...
                if (response.owner_records != null) {
                    response.owner_records!.forEach((o) => {
                        list.owner_records!.push({
                            ...
                            username: o.username,
                            max_num_score: o.max_num_score
                                ? Number(o.max_num_score)
                                : 0
                        });
                    });
                }
    ...
    async listLeaderboardRecordsAroundOwner(
        session: Session,
        leaderboardId: string,
        ownerId: string,
        limit?: number,
    ...
    async listMatches(
        ...
        return this.apiClient.listMatches(
            session.token,
            limit,
            authoritative,
            label,
    ...
    async listNotifications(
        ...
        return this.apiClient
            .listNotifications(session.token, limit, cacheableCursor)
    ...
    async listStorageObjects(
        ...
        return this.apiClient
            ...
            .then((response: ApiStorageObjectList) => {
                ...
                response.objects!.forEach((o) => {
                    result.objects.push({
                        ...
                        permission_read: o.permission_read
                            ? Number(o.permission_read)
                            : 0,
                        permission_write: o.permission_write
                            ? Number(o.permission_write)
                            : 0,
    ...
    async listTournaments(
        ...
        return this.apiClient
            ...
            .then((response: ApiTournamentList) => {
    ...
    async listTournamentRecords(
        ...
        return this.apiClient
            ...
            .then((response: ApiTournamentRecordList) => {
    ...
    async listTournamentRecordsAroundOwner(
        session: Session,
        tournamentId: string,
        ownerId: string,
        limit?: number,
    ...
    async readStorageObjects(
        session: Session,
        request: ApiReadStorageObjectsRequest
        ...
        return this.apiClient
            .readStorageObjects(session.token, request)
            .then((response: ApiStorageObjects) => {
    ...
    async rpc(
        ...
        return this.apiClient
            .rpcFunc(session.token, id, JSON.stringify(input))
    ...
    async sessionRefresh(
        ...
        if (session.created && session.expires_at! - session.created_at < 70) {
            console.warn(
                "Session lifetime too short, please set '--session.token_expiry_sec' option. See the documentation for more info: https://heroiclabs.com/docs/nakama/getting-started/configuration/#session"
            );
        }
        ...
        if (
            ...
            console.warn(
                "Session refresh lifetime too short, please set '--session.refresh_token_expiry_sec' option. See the documentation for more info: https://heroiclabs.com/docs/nakama/getting-started/configuration/#session"
            );
        }
        ...
        const apiSession = await this.apiClient.sessionRefresh(
            this.serverkey,
            "",
            { token: session.refresh_token, vars: vars }
        );
    ...
    async updateGroup(
        ...
        return this.apiClient
            .updateGroup(session.token, groupId, request)
            .then((response: any) => {
                return response !== undefined;
            });
    }
    ...
    async validatePurchaseApple(
        session: Session,
        receipt?: string,
        persist: boolean = true
    ): Promise<ApiValidatePurchaseResponse> {
        if (
            this.autoRefreshSession &&
            session.refresh_token &&
            session.isexpired((Date.now() + this.expiredTimespanMs) / 1000)
    ...
    async validatePurchaseFacebookInstant(
        session: Session,
        ...
        return this.apiClient.validatePurchaseFacebookInstant(session.token, {
    ...
    async validateSubscriptionApple(
        session: Session,
        receipt: string,
        persist: boolean = true
    ): Promise<ApiValidateSubscriptionResponse> {
        if (
            this.autoRefreshSession &&
            session.refresh_token &&
            session.isexpired((Date.now() + this.expiredTimespanMs) / 1000)
        ...
        return this.apiClient.validateSubscriptionApple(session.token, {
            receipt: receipt,
            persist: persist
        });
    }
    ...
    async validateSubscriptionGoogle(
        session: Session,
        receipt: string,
        persist: boolean = true
    ): Promise<ApiValidateSubscriptionResponse> {
        ...
        return this.apiClient.validateSubscriptionGoogle(session.token, {
            receipt: receipt,
            persist: persist
        });
    }
    ...
    async writeLeaderboardRecord(
        session: Session,
        leaderboardId: string,
        request: WriteLeaderboardRecord
        ...
        return this.apiClient
            .writeLeaderboardRecord(session.token, leaderboardId, {
            ...
            .then((response: ApiLeaderboardRecord) => {
                return Promise.resolve({
                    ...
                    max_num_score: response.max_num_score
                        ? Number(response.max_num_score)
                        : 0,
    ...
    async writeStorageObjects(
        session: Session,
        objects: Array<WriteStorageObject>
    ): Promise<ApiStorageObjectAcks> {
        if (
            this.autoRefreshSession &&
            session.refresh_token &&
            session.isexpired((Date.now() + this.expiredTimespanMs) / 1000)
    ...
    async writeTournamentRecord(
        session: Session,
        tournamentId: string,
        request: WriteTournamentRecord
    ): Promise<LeaderboardRecord> {
        return this.apiClient
            .writeTournamentRecord(session.token, tournamentId, {
                metadata: request.metadata
                    ? JSON.stringify(request.metadata)
                    : undefined,
                score: request.score,
